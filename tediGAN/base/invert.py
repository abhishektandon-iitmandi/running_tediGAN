...
def main():
  ...
  if args.mode == 'man':
    ...
    image_name = 'gen'
  save_image(f'{output_dir}/{image_name}_ori_3.png', viz_results[0])
  save_image(f'{output_dir}/{image_name}_enc_3.png', viz_results[1])
  save_image(f'{output_dir}/{image_name}_inv_3.png', viz_results[-1])
